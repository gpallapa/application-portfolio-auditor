...
## License & Authors
export SCANCODE_VERSION='32.3.1'

## Code quality / bugs
export MAI_VERSION='1.9.30'
export PMD_VERSION='7.9.0'
...
export SYFT_VERSION='1.18.1'
export GRYPE_VERSION='0.86.1'
export TRIVY_VERSION='0.58.1'
export OSV_VERSION='1.9.2'
export BEARER_VERSION='1.48.0'

# Supporting frameworks
export FERNFLOWER_VERSION='243.22562.218'
export MUSTACHE_VERSION='3.0.5'
export HBS_VERSION='6.3.0'
export D3_VERSION='7.9.0'
export JQUERY_VERSION='3.7.1'
export BOOTSTRAP_VERSION='5.3.3'
export BOOTSTRAP_ICONS_VERSION='1.11.3'
export TIMELINES_CHART_VERSION='2.14.0'
...
export DOTNET_RUNTIME_VERSION='9.0.0-alpine3.20'
...
export IMG_ECLIPSE_TEMURIN_21="eclipse-temurin:21.0.5_11-jre"
export IMG_GRADLE_8_JDK_21="gradle:8.12.0-jdk21"
export IMG_MAVEN_3_JDK_21="maven:3.9.9-eclipse-temurin-21"
